...
const ICP_CAMPAIGN_CANISTER_ID = 'be2us-64aaa-aaaaa-qaabq-cai';
const LEDGER_CANISTER_ID = 'ryjl3-tyaaa-aaaaa-aaaba-cai';
const HOST = window.location.origin;

export async function getIcpCampaignCanister() {
  return await getCanister(ICP_CAMPAIGN_CANISTER_ID, marketPlaceIDL);
}
